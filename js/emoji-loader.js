...
(function () {
    ...
    var o = (window._wpemojiSettings = a, "wpEmojiSettingsSupports");
    var s = ["flag", "emoji"];
    ...
    function f(e, t, n, a) {
        let r;
        const o = (r = "undefined" != typeof WorkerGlobalScope && self instanceof WorkerGlobalScope ? new OffscreenCanvas(300, 150) : document.createElement("canvas")).getContext("2d", { willReadFrequently: !0 }),
            s = (o.textBaseline = "top", o.font = "600 32px Arial", {});
        return e.forEach(e => { s[e] = t(o, e, n, a) }), s
    }
        ...
        if (!n) {
            if ("undefined" != typeof Worker && "undefined" != typeof OffscreenCanvas && "undefined" != typeof URL && URL.createObjectURL && "undefined" != typeof Blob) try {
                var e = "postMessage(" + f.toString() + "(" + [JSON.stringify(s), u.toString(), c.toString(), p.toString()].join(",") + "));",
                    a_blob = new Blob([e], { type: "text/javascript" });
                const r_worker = new Worker(URL.createObjectURL(a_blob), { name: "wpTestEmojiSupports" });
                return void (r_worker.onmessage = e => { i(n = e.data), r_worker.terminate(), t(n) })
            } catch (e) { }
            i(n = f(s, u, c, p))
        }
        t(n)
